...
const Contact = () => {
  ...
  <div className="mx-auto px-6 py-16 min-h-screen flex flex-col items-center justify-center bg-[#FFFFFF]" style={{ fontFamily: "'Poppins', sans-serif" }}>
      ...
      <div className="mt-16 text-center text-black text-base">
        Or email us directly at <a href="mailto:support@wahidfoods.com" className="text-newPrimary hover:text-black underline transition-colors duration-300 font-medium">support@CoreTech.com</a>
      </div>
    </div>
  );
};
