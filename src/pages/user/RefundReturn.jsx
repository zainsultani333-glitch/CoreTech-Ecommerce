      ...
      >
        ...
        <div className="min-h-[200px]">
          ...
          <p className="text-gray-800 mb-4 leading-relaxed">
            At <span className="font-semibold text-newPrimary">CoreTech</span>, we strive to ensure your satisfaction. This policy outlines the conditions under which refunds, returns, or exchanges may be processed for products purchased through our website.
          </p>
