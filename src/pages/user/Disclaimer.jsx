...
const disclaimerPoints = [
  ...
  },
  {
    ...
    text: "Please read all product labels, warnings, and directions provided by the manufacturer before use. CoreTech is not responsible for any adverse effects or damages resulting from the use or misuse of any product purchased through our platform.",
  },
  {
  ...
  },
  {
    ...
    text: (
      <>
        CoreTech is not liable for any direct, indirect, incidental, or consequential damages arising from the use of products purchased from our site. All purchases are subject to our{" "}
      ...
      <div className="container mx-auto max-w-7xl">
        ...
        <div className="mt-12 md:mt-16 text-center">
          <p className="text-gray-500 text-xs sm:text-sm">
            &copy; {new Date().getFullYear()} CoreTech. All rights reserved.
          </p>
        </div>
      </div>
    </div>
