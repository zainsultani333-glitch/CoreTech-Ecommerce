...
const apps = [
  {
    ...
    description:
      "CoreTech Android app offers a seamless shopping experience, push notifications, and secure payments. Download now and enjoy exclusive mobile deals!",
  },
  {
    platform: "iOS",
    ...
    description:
      "CoreTech iOS app brings you the best of our store, with fast checkout, order tracking, and personalized recommendations. Get it on your iPhone or iPad today!",
  },
];
...
const MobileApps = () => (
  <div className="container mx-auto px-4 py-12 min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-[#f0f9f7] to-[#e0f3ef]">
    ...
    >
      <h1 className="text-4xl font-bold text-newPrimary mb-8 text-center">CoreTech Mobile Apps</h1>
    </motion.div>
